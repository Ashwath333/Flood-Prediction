...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    static {
        ATTRS = new int[]{C0114R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mRemoveActionBarHideOffset = new C01212();
        this.mAddActionBarHideOffset = new C01223();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0114R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0114R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0114R.id.action_bar));
        }
    }
