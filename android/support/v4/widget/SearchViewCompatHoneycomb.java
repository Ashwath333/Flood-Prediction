...
class SearchViewCompatHoneycomb {
    ...
    static class C00881 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C00881(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C00892 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C00892(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
