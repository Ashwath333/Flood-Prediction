    ...
    private static class TextUtilsCompatImpl {
        ...
        public String htmlEncode(@NonNull String s) {
            ...
            for (int i = 0; i < s.length(); i++) {
                char c = s.charAt(i);
                switch (c) {
                    case C0148R.styleable.AppCompatTheme_actionModePasteDrawable /*34*/:
                        sb.append("&quot;");
                        break;
                    case C0148R.styleable.AppCompatTheme_actionModeWebSearchDrawable /*38*/:
                        sb.append("&amp;");
                        break;
                    case C0148R.styleable.AppCompatTheme_actionModePopupWindowStyle /*39*/:
                        sb.append("&#39;");
                        break;
                    case C0148R.styleable.AppCompatTheme_toolbarNavigationButtonStyle /*60*/:
                        sb.append("&lt;");
                        break;
                    case C0148R.styleable.AppCompatTheme_popupWindowStyle /*62*/:
                        sb.append("&gt;");
                        break;
                    default:
                        sb.append(c);
