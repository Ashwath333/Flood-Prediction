...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C01761());
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C00721();
        sInterpolator = new C00732();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C00743();
        ...
        for (i = SCROLL_STATE_IDLE; i < size; i += SCROLL_STATE_DRAGGING) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp != null && lp.isDecor) {
                    ...
                    int vgrav = lp.gravity & C0148R.styleable.AppCompatTheme_spinnerStyle;
