...
abstract class AppCompatDelegateImplBase extends AppCompatDelegate {
    ...
    static class C01091 implements UncaughtExceptionHandler {
        final /* synthetic */ UncaughtExceptionHandler val$defHandler;

        C01091(UncaughtExceptionHandler uncaughtExceptionHandler) {
    ...
    private class ActionBarDrawableToggleImpl implements Delegate {
        ...
        public Drawable getThemeUpIndicator() {
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), null, new int[]{C0114R.attr.homeAsUpIndicator});
    ...
    static {
        ...
        if (SHOULD_INSTALL_EXCEPTION_HANDLER && !sInstalledExceptionHandler) {
            Thread.setDefaultUncaughtExceptionHandler(new C01091(Thread.getDefaultUncaughtExceptionHandler()));
