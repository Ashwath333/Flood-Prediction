...
class PathParser {
    ...
    public static class PathDataNode {
        ...
        private static void addCommand(Path path, float[] current, char previousCmd, char cmd, float[] val) {
            ...
            switch (cmd) {
                case C0148R.styleable.AppCompatTheme_imageButtonStyle /*65*/:
                case C0148R.styleable.AppCompatTheme_textColorAlertDialogListItem /*97*/:
                    incr = 7;
                    break;
                case C0148R.styleable.AppCompatTheme_textAppearanceSearchResultSubtitle /*67*/:
                case C0148R.styleable.AppCompatTheme_buttonBarNegativeButtonStyle /*99*/:
                    incr = 6;
                    break;
                case C0148R.styleable.AppCompatTheme_listPreferredItemHeightLarge /*72*/:
                case C0148R.styleable.AppCompatTheme_colorControlNormal /*86*/:
                case C0148R.styleable.AppCompatTheme_checkboxStyle /*104*/:
                case 'v':
                    incr = 1;
                    break;
                case C0148R.styleable.AppCompatTheme_listPopupWindowStyle /*76*/:
                case C0148R.styleable.AppCompatTheme_textAppearanceListItem /*77*/:
                case C0148R.styleable.AppCompatTheme_colorPrimaryDark /*84*/:
                case C0148R.styleable.AppCompatTheme_ratingBarStyle /*108*/:
                case C0148R.styleable.AppCompatTheme_ratingBarStyleIndicator /*109*/:
                case 't':
                    incr = 2;
                    break;
                case C0148R.styleable.AppCompatTheme_panelMenuListTheme /*81*/:
                case C0148R.styleable.AppCompatTheme_colorPrimary /*83*/:
                case C0148R.styleable.AppCompatTheme_switchStyle /*113*/:
                case 's':
                    incr = 4;
                    break;
                case C0148R.styleable.AppCompatTheme_colorSwitchThumbNormal /*90*/:
                case 'z':
                    path.close();
    ...
    private static void extract(String s, int start, ExtractFloatResult result) {
        ...
        for (currentIndex = start; currentIndex < s.length(); currentIndex++) {
            ...
            switch (s.charAt(currentIndex)) {
                ...
                case C0148R.styleable.AppCompatTheme_dialogPreferredPadding /*44*/:
                    foundSeparator = true;
                    break;
                case C0148R.styleable.AppCompatTheme_listDividerAlertDialog /*45*/:
                    if (!(currentIndex == start || isPrevExponential)) {
                        foundSeparator = true;
                        result.mEndWithNegOrDot = true;
                        break;
                    }
                case C0148R.styleable.AppCompatTheme_actionDropDownStyle /*46*/:
                    if (!secondDot) {
                        secondDot = true;
                        break;
                    }
                    ...
                    result.mEndWithNegOrDot = true;
                    break;
                case C0148R.styleable.AppCompatTheme_searchViewStyle /*69*/:
                case C0148R.styleable.AppCompatTheme_autoCompleteTextViewStyle /*101*/:
                    isExponential = true;
                    break;
            }
            if (foundSeparator) {
