...
import com.example.arvind.floodwarning.BuildConfig;
...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C01384 implements OnFocusChangeListener {
        C01384() {
        }
    ...
    class C01395 implements OnLayoutChangeListener {
        C01395() {
        }
    ...
    class C01406 implements OnGlobalLayoutListener {
        C01406() {
        }
    ...
    class C01417 implements OnClickListener {
        C01417() {
        }
    ...
    class C01428 implements OnKeyListener {
        C01428() {
        }
    ...
    class C01439 implements OnEditorActionListener {
        C01439() {
        }
    ...
    static class SavedState extends AbsSavedState {
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C02021());
        }
    }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0114R.attr.autoCompleteTextViewStyle);
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0114R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowImeRunnable = new C01351();
        this.mUpdateDrawableStateRunnable = new C01362();
        this.mReleaseCursorRunnable = new C01373();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C01417();
        this.mTextKeyListener = new C01428();
        this.mOnEditorActionListener = new C01439();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0114R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0114R.styleable.SearchView_layout, C0114R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0114R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0114R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0114R.id.search_plate);
        this.mSubmitArea = findViewById(C0114R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0114R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0114R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0114R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0114R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0114R.id.search_mag_icon);
        this.mSearchPlate.setBackgroundDrawable(a.getDrawable(C0114R.styleable.SearchView_queryBackground));
        this.mSubmitArea.setBackgroundDrawable(a.getDrawable(C0114R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0114R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0114R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0114R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0114R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0114R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0114R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(C0114R.styleable.SearchView_suggestionRowLayout, C0114R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0114R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C01384());
        setIconifiedByDefault(a.getBoolean(C0114R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0114R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0114R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0114R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0114R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0114R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0114R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C01395());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C01406());
    }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0114R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0114R.dimen.abc_search_view_preferred_height);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0114R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0114R.dimen.abc_dropdownitem_text_padding_left) : 0;
