...
public class ListPopupWindow implements ShowableListMenu {
    ...
    class C01323 implements OnItemSelectedListener {
        C01323() {
        }
    ...
    class C01991 extends ForwardingListener {
        C01991(View src) {
            super(src);
        }
    ...
    public ListPopupWindow(@NonNull Context context) {
        this(context, null, C0114R.attr.listPopupWindowStyle);
    }

    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C0114R.attr.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0114R.styleable.ListPopupWindow, defStyleAttr, defStyleRes);
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(C0114R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, POSITION_PROMPT_ABOVE);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(C0114R.styleable.ListPopupWindow_android_dropDownVerticalOffset, POSITION_PROMPT_ABOVE);
        ...
        if (isShowing() && keyCode != 62 && (this.mDropDownList.getSelectedItemPosition() >= 0 || !isConfirmKey(keyCode))) {
            ...
            if (!(below && keyCode == 19 && curIndex <= firstItem) && (below || keyCode != 20 || curIndex < lastItem)) {
                ...
                if (this.mDropDownList.onKeyDown(keyCode, event)) {
                    ...
                    show();
                    switch (keyCode) {
                        case C0148R.styleable.Toolbar_titleMargins /*19*/:
                        case C0148R.styleable.Toolbar_maxButtonHeight /*20*/:
                        case C0148R.styleable.Toolbar_collapseContentDescription /*23*/:
                        case C0148R.styleable.AppCompatTheme_textAppearanceSearchResultTitle /*66*/:
                            return true;
                    }
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C01312();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C01323());
